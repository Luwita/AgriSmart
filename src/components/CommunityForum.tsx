  ...
  const upcomingEvents = [
    {
      ...
      attendees: 45,
      maxAttendees: 60,
      description: 'Learn about sustainable farming practices and organic certification'
    },
    {
      id: 2,
      ...
      attendees: 128,
      maxAttendees: 200,
      description: 'Expert-led session on integrated fall armyworm management'
    },
    {
      id: 3,
      ...
      attendees: 234,
      maxAttendees: 500,
      description: 'Annual conference on maize marketing and value chain development'
    }
  ];
      ...
      <div className="bg-gradient-to-r from-orange-500 to-red-600 rounded-lg shadow-sm text-white p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="bg-white bg-opacity-20 rounded-lg p-3">
            ...
            <p className="text-sm opacity-90">156 farmers increased yields by 30%+</p>
          </div>
        </div>
      </div>
