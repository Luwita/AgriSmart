...
const AdminDashboard: React.FC = () => {
  ...
  const handleEditFarm = (farm: any) => {
    ...
    setEditFarmForm({
      ...
      establishedYear: farm.establishedYear.toString(),
    ...
    const updatedFarms = farms.map(farm => 
      farm.id === selectedFarm.id 
        ? {
            ...
            location: editFarmForm.location,
            province: editFarmForm.province,
            totalArea: parseInt(editFarmForm.totalArea) || 0,
            soilType: editFarmForm.soilType,
            waterSource: editFarmForm.waterSource,
            establishedYear: parseInt(editFarmForm.establishedYear) || 0,
            certification: editFarmForm.certification,
            farmingType: editFarmForm.farmingType,
            coordinates: editFarmForm.coordinates
          }
        : farm
    );
    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="bg-white rounded-lg shadow-lg max-w-3xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6">
              <div className="bg-green-50 rounded-lg p-6 mb-6">
                <div className="flex items-center justify-between mb-4">
                  <h4 className="text-xl font-bold text-green-800">{selectedFarm.name}</h4>
                  <span className={`px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(selectedFarm.status)}`}>
                    {selectedFarm.status}
                  </span>
                </div>
                <p className="text-green-700 mb-2">Owned by: {selectedFarm.owner}</p>
                <div className="flex items-center text-green-700 mb-4">
                  <MapPin className="w-4 h-4 mr-1" />
                  <span>{selectedFarm.location}, {selectedFarm.province}</span>
                </div>
                <p className="text-sm text-green-600">Coordinates: {selectedFarm.coordinates}</p>
              </div>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                  <h5 className="font-semibold text-gray-900 mb-3">Farm Information</h5>
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      <span className="text-gray-600">Total Area:</span>
                      <span className="font-medium">{selectedFarm.totalArea} hectares</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{selectedFarm.waterSource}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Established:</span>
                      <span className="font-medium">{selectedFarm.establishedYear}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Certification:</span>
                      <span className="font-medium">{selectedFarm.certification}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Farming Type:</span>
                      <span className="font-medium">{selectedFarm.farmingType}</span>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-emerald-600">{selectedFarm.performance}%</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Crops:</span>
                      <span className="font-medium">{selectedFarm.cropsCount} active crops</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">IoT Devices:</span>
                      <span className="font-medium">{selectedFarm.devicesCount} devices</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-blue-600">2,450 L/day</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Carbon Footprint:</span>
                      <span className="font-medium text-green-600">1.8 tons CO₂/year</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      {showEditFarmModal && selectedFarm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg shadow-lg max-w-3xl w-full max-h-[90vh] overflow-y-auto">
            <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
              <h3 className="text-lg font-semibold text-gray-900">Edit Farm</h3>
              <button 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setEditFarmForm({...editFarmForm, name: e.target.value})}
                ...
                <div>
                  ...
                  <select
                    ...
                    disabled
                  >
                    <option>{selectedFarm.owner}</option>
                  </select>
                </div>
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={editFarmForm.location}
                    onChange={(e) => setEditFarmForm({...editFarmForm, location: e.target.value})}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Province</label>
                  <select
                    value={editFarmForm.province}
                    onChange={(e) => setEditFarmForm({...editFarmForm, province: e.target.value})}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500"
                  >
                    {zambianProvinces.map(province => (
                      <option key={province} value={province}>{province}</option>
                ...
                <div>
                  ...
                  <input
                    type="number"
                    value={editFarmForm.totalArea}
                    onChange={(e) => setEditFarmForm({...editFarmForm, totalArea: e.target.value})}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500"
                    placeholder="Enter total area"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={editFarmForm.soilType}
                    onChange={(e) => setEditFarmForm({...editFarmForm, soilType: e.target.value})}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500"
                ...
                <div>
                  ...
                  <input
                    type="number"
                    value={editFarmForm.establishedYear}
                    onChange={(e) => setEditFarmForm({...editFarmForm, establishedYear: e.target.value})}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500"
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={editFarmForm.certification}
                    onChange={(e) => setEditFarmForm({...editFarmForm, certification: e.target.value})}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500"
                ...
                <div>
                  ...
                  <select
                    value={editFarmForm.farmingType}
                    onChange={(e) => setEditFarmForm({...editFarmForm, farmingType: e.target.value})}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500"
                  >
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={editFarmForm.coordinates}
                    onChange={(e) => setEditFarmForm({...editFarmForm, coordinates: e.target.value})}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500"
                    placeholder="Enter coordinates (e.g., -15.4067, 28.2871)"
                  />
                </div>
              </div>
